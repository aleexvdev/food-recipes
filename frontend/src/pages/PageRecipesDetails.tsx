  ...
  return (
    <main className='h-auto'>
      <section className='h-auto min-h-screen w-full mx-auto max-w-6xl transition-opacity'>
        <div className='w-full h-full flex flex-col-reverse md:flex-row items-start justify-start pt-28 md:pt-32 pb-20 px-5 md:px-0'>
          ...
          <div className='w-full md:w-[70%] h-full pl-5'>
            <AnimatePresence>
              <div className='flex flex-col-reverse md:flex-row items-start justify-between gap-5 w-full'>
              ...
              <div className='w-full pt-6 flex items-center justify-between border-b-2 border-gray-300 pb-3'>
                <div className='flex items-center gap-2'>
                  ...
                  <span className='font-bold text-2xl md:text-3xl banner-title'>Ingredients</span>
                </div>
